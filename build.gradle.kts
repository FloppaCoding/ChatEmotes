...
loom {
    launchConfigs {
        getByName("client") {
            ...
            arg("--mixin", "mixins.chatemotes.json")
        }
    }
    forge {
        pack200Provider.set(Pack200Adapter())
        mixinConfig("mixins.chatemotes.json")
    }
    mixin {
        defaultRefmapName.set("mixins.chatemotes.refmap.json")
    }
}
...
tasks {
    ...
    named<Jar>("jar") {
        manifest.attributes(
            ...
            "FMLCorePlugin" to "chatemotes.forge.FMLLoadingPlugin",
            "ForceLoadAsMod" to true,
            "MixinConfigs" to "mixins.chatemotes.json",
            "ModSide" to "CLIENT",
    ...
    named<RemapJarTask>("remapJar") {
        archiveBaseName.set("ChatEmotes")
